...
@Localization("ntrpg.skills")
public class SkillLocalization {

	public static Text STR;
	public static Text STR_DESC;
	public static Text INT_DESC;
	public static Text AGI_DESC;
	public static Text INT;
	public static Text AGI;
