...
public class SkillPreUsageEvent extends AbstractIEntityCancellableEvent implements SkillEvent {
	private final SkillContext context;

	public SkillPreUsageEvent(IEntity target, SkillContext context) {
		super(target);
