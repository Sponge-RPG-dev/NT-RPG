...
public class MinimalItemGroupRequirementsData extends
    ...
    public static class Builder extends AbstractDataBuilder<MinimalItemGroupRequirementsData>
            implements DataManipulatorBuilder<MinimalItemGroupRequirementsData, Immutable> {
