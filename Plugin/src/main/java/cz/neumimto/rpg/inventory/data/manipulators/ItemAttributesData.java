...
public class ItemAttributesData extends AbstractData<ItemAttributesData, ItemAttributesData.Immutable> {
    ...
    public static class Builder extends AbstractDataBuilder<ItemAttributesData> implements DataManipulatorBuilder<ItemAttributesData, ItemAttributesData.Immutable> {
