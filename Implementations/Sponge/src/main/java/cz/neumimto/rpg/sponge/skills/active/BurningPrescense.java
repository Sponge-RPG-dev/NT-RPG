...
import cz.neumimto.rpg.sponge.effects.positive.BurningPrescenseEffect;
import cz.neumimto.rpg.sponge.model.BPModel;
...
public class BurningPrescense extends ActiveSkill {
    ...
    public void init() {
        super.init();
        settings.addNode(SkillNodes.PERIOD, 1000);
        settings.addNode(SkillNodes.RADIUS, 3);
        settings.addNode(SkillNodes.DAMAGE, 5);
