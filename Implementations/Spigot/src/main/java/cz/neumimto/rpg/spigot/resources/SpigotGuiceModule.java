...
import cz.neumimto.rpg.spigot.effects.FolliaEffectService;
...
public class SpigotGuiceModule extends AbstractRpgGuiceModule {
    ...
    protected Map getBindings() {
        ...
        map.put(EffectService.class, Platform.isFolia() ? FolliaEffectService.class : SpigotEffectService.class);
